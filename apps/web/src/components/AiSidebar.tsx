    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-6 right-6 rounded-full bg-indigo-600 px-4 py-3 text-sm font-medium text-white shadow-lg hover:bg-indigo-700 transition-all z-40"
        >
          ✨ Ask AI
        </button>
      )}
      ...
      <div
        className={`fixed bottom-6 right-6 flex h-[32rem] w-96 flex-col rounded-lg border bg-white shadow-xl transition-transform duration-200 ease-in-out z-50 ${
